...
def _render_qmd(terms: list[dict[str, Any]], path: Path) -> None:
    ...
    lines = [
        ...
        "`docs/glossary/terms.yml`; generated Quarto, Typst, and KG artifacts",
...
def build(args: argparse.Namespace) -> None:
    ...
    if "all" in actions:
        actions = {"validate", "render-quarto", "render-typst", "render-jsonl"}
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        nargs="*",
        default=["all"],
        choices=["all", "validate", "render-quarto", "render-typst", "render-jsonl"],
    )
