...

{
  ...
  echo "2. Implemented substrate: docs/typst/seminar_paper/main.typ"
  echo "3. Current thesis direction: docs/contents/thesis/{roadmap,questions}.qmd plus .agents/memory/state/{PROJECT_STATE,DECISIONS,OPEN_QUESTIONS,GOTCHAS}.md"
  echo "4. Advisor proposal narrative: docs/typst/thesis/proposal.typ"
  echo "5. Compact routing index: docs/_generated/context/source_index.md"
  echo "6. On-demand references: .agents/references/{operator_quick_reference,python_conventions,agent_memory_templates,context7_library_ids}.md"
  ...
  echo "| Typst paper | ${typst_paper_count} files | You need implemented-substrate evidence or seminar-paper wording | \`scripts/nbv_typst_includes.py --paper --mode outline\` |"
