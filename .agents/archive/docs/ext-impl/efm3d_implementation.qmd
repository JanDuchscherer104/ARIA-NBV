---
title: "Archived EFM3D Implementation Index"
phase: archive
audience: agent
status: deprecated
owner: agent
...
> Archive note: this page is historical raw vendor-stack scratch from an
> earlier public docs pass. It is deprecated and is not current thesis or
> implementation guidance. Use
> `../../../references/external_stack_contracts.md` for the maintained
> ATEK/EFM3D/Project Aria developer contract.
