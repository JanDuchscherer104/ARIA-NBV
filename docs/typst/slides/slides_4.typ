// Slide deck: Oracle RRI + diagnostics + sweep evidence
// Follows paper contents and uses real Optuna/W&B + Streamlit figures.
  ...
  #grid(
    ...
    [
      ...
      #color-block(title: [Scope in this work])[
        ...
        - Offline depth rendering and point #sym.arrow.r mesh evaluation.
...
#section-slide(
  title: [VIN v2 Scoring Architecture],
  ...
  #grid(
    ...
    [
      #color-block(title: [RRI definition])[
        ...
        - Accuracy (P #sym.arrow.r M) + completeness (M #sym.arrow.r P).
      ]
    ],
    [
...
#slide(title: [Diagnostics gallery])[
  #figure(
    grid(
      ...
      rows: (1fr, 1fr),
      gutter: 8pt,
      image(fig_path + "app/render_frusta.png", width: 100%), image(fig_path + "app/depth_hist.png", width: 100%),
      image(fig_path + "app/semidense.png", width: 100%), image(fig_path + "app/depth_render.png", width: 100%),
    ),
