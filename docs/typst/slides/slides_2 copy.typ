...
#slide(title: [Reconstruction Quality Metrics Theory])[
  ...
  #quote-block[
    *ATEK Implementation*: `evaluate_single_mesh_pair()`#footnote[#link("https://github.com/facebookresearch/ATEK/blob/main/atek/evaluation/surface_reconstruction/surface_reconstruction_metrics.py")[src]] computes all metrics using trimesh sampling and PyTorch3D distance functions @ATEK-about-2025
  ]
]
