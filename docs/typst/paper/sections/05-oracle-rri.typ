...
depth rendering (see #gh("oracle_rri/oracle_rri/data/mesh_cache.py")).

The end-to-end oracle labeler is implemented in
#gh("oracle_rri/oracle_rri/pipelines/oracle_rri_labeler.py").
...
#gh("oracle_rri/oracle_rri/pose_generation/positional_sampling.py")).
...
(#gh("oracle_rri/oracle_rri/pose_generation/orientations.py")). The most common mode
...
(#gh("oracle_rri/oracle_rri/pose_generation/candidate_generation_rules.py")). Let
...
Depth rendering is implemented in #gh("oracle_rri/oracle_rri/rendering/pytorch3d_depth_renderer.py") using PyTorch3D's
...
#gh("oracle_rri/oracle_rri/rendering/candidate_pointclouds.py"). For pixel centers
...
empirical quantile edges (#gh("oracle_rri/oracle_rri/rri_metrics/rri_binning.py")).
