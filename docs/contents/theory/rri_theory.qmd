...
The {{< gls relative-reconstruction-improvement >}} metric introduced by VIN-NBV quantifies the expected reconstruction quality gain from capturing a new viewpoint:
...
- $\text{d}(\cdot, \cdot)$: a bidirectional surface similarity metric, typically Chamfer distance for PC to PC comparison, defined in [Surface Reconstruction Metrics](surface_metrics.qmd).
