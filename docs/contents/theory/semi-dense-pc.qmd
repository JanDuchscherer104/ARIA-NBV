...
**EVL** (Egocentric Voxel Lifting) [@EFM3D-straub2024, Sec. 4] lifts 2-D features into a **gravity-aligned voxel volume**.  It makes explicit use of the semi-dense SLAM tracks:
...
### Semi-dense vs. dense ground truth in RRI
...
* Prefer **point-to-mesh distances** (see [Surface Metrics](surface_metrics.qmd)) instead of point-to-point Chamfer when comparing a semi-dense prediction to a dense mesh.
