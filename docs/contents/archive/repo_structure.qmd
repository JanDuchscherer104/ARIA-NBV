...
---
::: {.callout-note}
This historical structure page is retained for context. Prefer the generated
API reference, `docs/_generated/context/source_index.md`, and targeted `rg`
queries for current repository structure.
:::
