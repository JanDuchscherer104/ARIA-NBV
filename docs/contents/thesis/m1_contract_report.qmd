...
| Current local store evidence | Blocked for M1 exit | `.configs/offline_only.toml` resolves to `.data/offline_cache/vin_offline`; the evidence snapshot below records manifest v6, 48 sample-index rows, and an interrupted/partial one-scene store. |
