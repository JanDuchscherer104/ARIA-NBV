...
- track proposal freeze and bibliography audit as M0/M1 advisor deliverables
  through the agents DB, with `make proposal-pdf` as the proposal render
  command and the generated proposal PDF tracked once frozen;
...
- Zarr-first rollout/Q storage schema drafted before large sequence data is
  written;
