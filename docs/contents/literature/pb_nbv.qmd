...
**Related ARIA-NBV pages.** [NBV background](../theory/nbv_background.qmd), [RRI theory](../theory/rri_theory.qmd), [oracle RRI API](../../reference/rri_metrics.oracle_rri.qmd), and [Hestia](hestia.qmd).
