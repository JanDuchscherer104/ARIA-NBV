...
**Related ARIA-NBV pages.** [EFM3D/EVL](efm3d.qmd), [ASE dataset](../ase_dataset.qmd), [semi-dense point clouds](../theory/semi-dense-pc.qmd), and [oracle RRI API](../../reference/rri_metrics.oracle_rri.qmd).
