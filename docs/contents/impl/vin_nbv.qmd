...
currently trained in the repo: a frozen EVL backbone, explicit
...
- Core model: [`VinModelV3Config`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/model_v3.py#L123), [`VinModelV3`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/model_v3.py#L256), [`VinModelV3.forward`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/model_v3.py#L1531)
- Encoders: [`R6dLffPoseEncoder`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/pose_encoders.py#L73), [`LearnableFourierFeatures`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/pose_encoding.py#L25), [`TrajectoryEncoder`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/traj_encoder.py#L48)
- Backbone and typed outputs: [`EvlBackbone`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/backbone_evl.py#L81), [`EvlBackboneOutput`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/types.py#L21), [`VinPrediction`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/types.py#L200)
- Projection and CORAL: [`semidense_proj_feature_index`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/semidense_projection.py#L34), [`CoralLayer`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/rri_metrics/coral.py#L220), [`MonotoneBinValues`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/rri_metrics/coral.py#L111)
:::

# What VINv3 Does

Given one egocentric snippet and a set of candidate next-view poses, [`VinModelV3`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/model_v3.py#L256)
...
The current forward interface of [`VinModelV3.forward`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/model_v3.py#L1531) is:
...
The scorer consumes a frozen EVL backbone through [`EvlBackboneOutput`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/types.py#L21). In the
...
Each candidate pose is re-expressed in the reference rig frame and encoded by
[`R6dLffPoseEncoder`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/pose_encoders.py#L73) on top of [`LearnableFourierFeatures`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/pose_encoding.py#L25):
...
[`VinModelV3`](https://github.com/JanDuchscherer104/NBV/blob/main/aria_nbv/aria_nbv/vin/model_v3.py#L256) can also encode the snippet rig trajectory in the same reference
