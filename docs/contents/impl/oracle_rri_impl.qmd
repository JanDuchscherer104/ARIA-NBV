...
This document provides a comprehensive overview of all EFM3D and ATEK functions that are relevant for implementing the aria_nbv Relative Reconstruction Improvement (RRI) computation for Next-Best-View planning.
