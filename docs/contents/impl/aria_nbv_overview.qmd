...
- In-repo NBV toolkit (import path currently `oracle_rri`) for ASE/ATEK + EFM3D experiments.
...
flowchart LR
    ...
    C -->|PoseTW batch + masks| D(rendering.\nCandidateDepthRenderer)
    D -->|Depth→PC (EFM3D pointcloud utils)| E[Fused reconstruction P_{t∪q}]
