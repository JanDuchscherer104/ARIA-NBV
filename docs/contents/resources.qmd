...
This section provides an overview of the libraries, tools, and documentation
used in this project. Internal agent guidance lives under `.agents/` and is not
part of the public documentation front door.
