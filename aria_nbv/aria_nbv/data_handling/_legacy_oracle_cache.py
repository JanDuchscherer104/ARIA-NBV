...
This module implements the legacy per-sample oracle cache path. Remove it once
all training, app, and operator flows use the immutable VIN offline store.
...
from ._legacy_vin_cache import VinSnippetCacheConfig
from ._legacy_vin_provider import (
    EfmSnippetProvider,
...
class OracleRriCacheWriterConfig(BaseConfig):
...
class OracleRriCacheDatasetConfig(BaseConfig):
