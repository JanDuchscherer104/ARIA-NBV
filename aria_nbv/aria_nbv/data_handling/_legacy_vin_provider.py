...
These providers exist to keep the legacy oracle-cache reader working during the
offline-store migration. Remove this module after the cache cutover.
...
from ._legacy_offline_cache_store import _extract_snippet_token
