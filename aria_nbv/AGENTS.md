...
- Prefer `Enum` for categorical values and `match-case` for multi-branch logic.
...
- For config models, document fields with attribute / field docstrings instead of `Field(..., description=...)`.
